  ...
  webServer: [
    {
      ...
      command: `${VENV_PYTHON} ${MOCK_SERVER}`,
    ...
    },
    {
      ...
      command: `MNESOS_DB_PATH=${E2E_DB_PATH} MNESOS_STATIC_DIR=${STATIC_DIR} OPENROUTER_BASE_URL=http://127.0.0.1:8899/api/v1 ${VENV_UVICORN} MnesOS.api.app:app --host 0.0.0.0 --port 8000`,
