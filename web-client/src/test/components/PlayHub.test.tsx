...
describe('PlayHub', () => {
  ...
  it('shows loading state initially', () => {
    ...
    render(<PlayHub onStartNewGame={vi.fn()} />)
  ...
  it('calls onStartNewGame when new game card is clicked', async () => {
    ...
    render(<PlayHub onStartNewGame={onStartNewGame} />)
  ...
  it('dispatches mnesos-play-instance and calls setInstanceId on Resume', async () => {
    vi.mocked(client.listInstances).mockResolvedValue(mockInstances)
    const user = userEvent.setup()
