...
3. **Apply Mechanics & Time:** Call the appropriate YARE tools to execute mechanics for both the player and the NPCs. 
   - For EVERY tool call, you MUST provide a realistic time estimate in the `_engine_time_delta` parameter (use ISO 8601 duration format, e.g., `PT5M` for 5 minutes, `PT1H` for 1 hour).
